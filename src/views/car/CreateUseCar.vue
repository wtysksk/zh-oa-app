<template>
    <div class="component-content">
        <van-form>
            ...
            <van-field label="司机：" input-align="right" placeholder="请填写司机名称" />
            ...
            <van-field label="出发地：" input-align="right" placeholder="请填写出发地" />
            <van-field label="目的地：" input-align="right" placeholder="请填写目的地" />
